...
function App() {
  ...
  return (
    <div>
      <img src="https://heroic-pixie-6d7f91.netlify.app/awning.png"></img>
      <h1 style={{color: 'white', textShadow: 'grey 5px 0 10px', padding: '10px'   }}> Food Truck Favorites!</h1>
      <Container >
      <Row >
        <Col>      
        <Listing title = "Birria-Landia"
         category = "Mexican"
      ...
      <Row >
        ...
        <Col>      
        <Listing title = "King Souvlaki of Astoria"
         category = "Greek"
      ...
      <Row >
        <Col>      
        <Listing title = "Ling's Sweet Mini Cakes"
         category = "Chinese"
